    ...
    <section id="contact" className="w-full py-20 px-6 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-14">
          <h2 data-aos="fade-zoom-in" data-aos-delay="100" className="text-4xl font-bold mb-4 text-gray-800 font-[Abel]">Get In Touch</h2>
          <div data-aos="fade-zoom-in" data-aos-delay="100" className="w-20 h-1 bg-blue-500 mx-auto mb-6"></div>
          <p data-aos="fade-zoom-in" data-aos-delay="100" className="text-gray-600 text-lg max-w-2xl mx-auto font-[Abel]">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          >
            ...
            <h3 className="font-semibold text-lg mb-2 text-gray-800 font-[Abel]">Phone</h3>
            <p className="text-gray-600 text-center mb-4 font-[Abel]">Call or text me</p>
            <span className="text-blue-600 font-medium group-hover:text-blue-800 transition-colors font-[Abel]">+81 80-5834-4559</span>
          </a>
          ...
          >
            ...
            <h3 className="font-semibold text-lg mb-2 text-gray-800 font-[Abel]">Email</h3>
            <p className="text-gray-600 text-center mb-4 font-[Abel]">Send me a message</p>
            <span className="text-red-600 font-medium group-hover:text-red-800 transition-colors break-all font-[Abel]">aguswidodo1197@gmail.com</span>
          </a>
          ...
          >
            ...
            <h3 className="font-semibold text-lg mb-2 text-gray-800 font-[Abel]">Instagram</h3>
            <p className="text-gray-600 text-center mb-4 font-[Abel]">Follow my work</p>
            <span className="text-pink-600 font-medium group-hover:text-pink-800 transition-colors font-[Abel]">@agus_photo</span>
          </a>
        </div>

        {/* Additional note */}
        <p data-aos="fade-zoom-in" data-aos-delay="100" className="text-center text-gray-500 mt-12 text-sm font-[Abel]">
